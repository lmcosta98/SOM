...
class SOM1A(SOM):
    ...
    def decay_learning_rate(self, initial_learning_rate, iteration, num_iterations):
        # usando uma função de learning rate do tipo Inverse of Time conforme especificado neste paper: http://www.ijmo.org/vol6/504-M08.pdf
        # na figura (6)
...
class SOM1B(SOM):         
    ...
    def decay_radius(self, iteration):
        # usando uma função de neighbourhood radius do tipo Linear
